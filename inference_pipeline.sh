...
python inference_pipeline.py path_experiment=${PATH_EXPERIMENT}  inference.audio=$audio $iteration  checkpoint="checkpoint_149" inference.apply_lpf=False inference.exp_name=$name bwe.add_noise.add_noise=$add_noise inference.fc=$fc
